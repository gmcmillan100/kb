...
gmcmilla-mn1:javadoc gmcmilla$ which java
/usr/bin/java
gmcmilla-mn1:javadoc gmcmilla$ which javadoc
/usr/bin/javadoc
...
```
gmcmilla-mn1:javadoc gmcmilla$ javadoc AddNum.java
...
gmcmilla-mn1:javadoc gmcmilla$ ls
...
Displaying Javadoc in CRT
Go to go/docin <mp-name>. Replace <mp-name> with the name of your MP.

Under the Type menu, click on a project name to view its Javadoc:
